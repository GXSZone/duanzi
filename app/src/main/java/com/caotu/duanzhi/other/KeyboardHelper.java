...
public class KeyboardHelper {
    ...
    public KeyboardHelper(Activity activity, EditText editText, View emojiPanelView, View emojiPanelSwitchView, View contentView) {
    ...
    private void init(Activity activity, EditText editText, View emojiPanelView, View emojiPanelSwitchView, View contentView) {
        ...
        this.editText.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(final View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP && KeyboardHelper.this.emojiPanelView.isShown()) {
        ...
        this.contentView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                    if (KeyboardHelper.this.emojiPanelView.isShown()) {
