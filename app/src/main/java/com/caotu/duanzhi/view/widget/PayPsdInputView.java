...
public class PayPsdInputView extends AppCompatEditText {
    ...
    private final static int psdType_point = 2;
...
//       super.onDraw(canvas);
    ...
    private void drawPoint(Canvas canvas) {
        //这里自己写死颜色和宽度
        borderPaint.setStrokeWidth(DevicesUtils.dp2px(2));
        borderPaint.setColor(getResources().getColor(R.color.color_747E8A));
        radius = DevicesUtils.dp2px(5);
