...
public class ExpandText extends AppCompatTextView {
    ...
    private static final int TO_EXPAND_HINT_COLOR = Color.WHITE;
    private static final int TO_SHRINK_HINT_COLOR = Color.WHITE;
    ...
    private static final boolean SHOW_NEW_LINE = false;
        ...
        switch (mCurrState) {
            case STATE_SHRINK: {
                ...
                if (mShowToExpandHint) {
                    ...
                    ssbShrink.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), ssbShrink.length() - getLengthOfString(mToExpandHint), ssbShrink.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                return ssbShrink;
            }
            case STATE_EXPAND: {
                ...
                ssbExpand.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), ssbExpand.length() - getLengthOfString(mToShrinkHint), ssbExpand.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                return ssbExpand;
            }
        }
        return mOrigText;
    ...
    public interface OnExpandListener {
        void onExpand(ExpandText view);

        void onShrink(ExpandText view);
    }
    ...
    private class TouchableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            if (hasOnClickListeners()
                    && (getOnClickListener(ExpandText.this) instanceof ExpandableClickListener)) {
            } else {
                toggle();
            }
        }
