...
public class SearchUserAdapter extends BaseQuickAdapter<UserBean, BaseViewHolder> {
    ...
    public void bindTitleText(AvatarWithNameLayout nameLayout, String username, String num) {
        nameLayout.setUserText(username, num);
    }
