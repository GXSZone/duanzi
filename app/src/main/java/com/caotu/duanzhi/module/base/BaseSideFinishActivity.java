...
public abstract class BaseSideFinishActivity extends BaseActivity {
    ...
    public boolean isAndroidO = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
//        isAndroidO = android.os.Build.VERSION.SDK_INT == Build.VERSION_CODES.O;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (!isAndroidO) swipeLayout.replaceLayer(this);
    }
...
//        }
        ...
        public boolean dispatchTouchEvent(@NonNull MotionEvent ev) {
            if (canSwipe() && !canSwipe && !ignoreSwipe) {
                if (swipeAnyWhere) {
                    switch (ev.getAction()) {
