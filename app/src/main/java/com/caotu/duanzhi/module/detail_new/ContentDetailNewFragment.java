 ...
 */
public class ContentDetailNewFragment extends BaseStateFragment<CommendItemBean.RowsBean> implements BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.OnItemClickListener, HandleBackInterface, BaseQuickAdapter.OnItemLongClickListener, TextViewLongClick {
...
//        adapter.setHeaderAndEmpty(true);
        FrameLayout layout = rootView.findViewById(R.id.fl_header);
        View headerView = LayoutInflater.from(getContext()).inflate(R.layout.layout_content_detail_header, layout, false);
