...
//	private boolean isCheckCodec = true; // 是否检测
     ...
     */
    public void setVideoPercent(float percent) {
        aBitRate = (int) (aBitRate * percent);
        aMaxBitRate = (int) (aMaxBitRate * percent);
        vCodecWidth = (int) (vWidth * percent);
        vCodecHeight = (int) (vHeight * percent);
    }
}
